...
import com.malav.medicinesontheway.dialogs.AdvancedRepeatSelector;
import com.malav.medicinesontheway.dialogs.DaysOfWeekSelector;
import com.malav.medicinesontheway.dialogs.IconPicker;
import com.malav.medicinesontheway.dialogs.RepeatSelector;
import com.malav.medicinesontheway.model.Colour;
import com.malav.medicinesontheway.model.Reminder;
import com.malav.medicinesontheway.services.AlarmReceiver;
import com.malav.medicinesontheway.utils.AlarmUtil;
import com.malav.medicinesontheway.utils.AnimationUtil;
import com.malav.medicinesontheway.utils.DatabaseHelper;
import com.malav.medicinesontheway.utils.DateAndTimeUtil;
import com.malav.medicinesontheway.utils.TextFormatUtil;
...
public class CreateEditActivity extends AppCompatActivity implements ColorChooserDialog.ColorCallback,
    ...
    @BindView(R.id.select_colour) TextView colourTextView;
    ...
    public void onColorSelection(@NonNull ColorChooserDialog dialog, @ColorInt int selectedColour) {
        ...
        colourText.setBackgroundColor(selectedColour);
    ...
    public void onRepeatSelection(DialogFragment dialog, int which, String repeatText) {
        ...
        if(which == Reminder.NONE){
            this.repeatText.setError("Please select value");
        }else {
    ...
    public void validateInput() {
        ...
        if(timeText.getText().equals("Time")){
            Snackbar.make(coordinatorLayout, R.string.toast_select_time, Snackbar.LENGTH_SHORT).show();
            imageWarningTime.setVisibility(View.VISIBLE);
        }else if(dateText.getText().equals("Date")){
            Snackbar.make(coordinatorLayout, R.string.toast_select_date, Snackbar.LENGTH_SHORT).show();
            imageWarningDate.setVisibility(View.VISIBLE);
        } else if(repeatType == Reminder.NONE){
            Snackbar.make(coordinatorLayout, "Please Select Repetition", Snackbar.LENGTH_SHORT).show();
